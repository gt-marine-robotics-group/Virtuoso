Two common filters, the extended kalman filter and unscented kalman filter are implemented. The extended kalman filter can also be used as a standard kalman filter. 
