...
class testWaypointGenerator(Node):
    ...
    def __init__(self):
        ...
        self.targetPose.position.x = 20.0
        self.targetPose.position.y = 20.0        
        self.targetPose.orientation.z = numpy.sin(55*numpy.pi/180/2)
        self.targetPose.orientation.w = numpy.cos(55*numpy.pi/180/2)
